// Music Memory/Components/Lists/SortHandlers/PlaylistsSortHandlerFactory.swift
import Foundation
...
struct PlaylistsSortHandlerFactory: SortHandlerFactory {
    typealias T = PlaylistData
    typealias SortOption = PlaylistSortOption
    
    func createSortHandler(for option: PlaylistSortOption) -> ((PlaylistData, PlaylistData) -> Bool)? {
        switch option {
        case .playCount:
