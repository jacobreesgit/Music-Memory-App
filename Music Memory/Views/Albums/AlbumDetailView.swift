...
struct AlbumDetailView: View {
        ...
        MediaDetailView(
            ...
            additionalContent: { album in
                Group {
                    ...
                    // Artist section - now with contextual ranking
                    ...
                    // Genres section - now with contextual rankings
    ...
    private func getAlbumRankInArtist(album: AlbumData, artist: ArtistData) -> RankData? {
    ...
    private func getAlbumRankInGenre(album: AlbumData, genre: GenreData) -> RankData? {
    ...
    private func getAlbumRankInPlaylist(album: AlbumData, playlist: PlaylistData) -> RankData? {
